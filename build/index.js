...
function startServer(port) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var models_1, server, url, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, index_1.default.sequelize.sync()];
                case 1:
                    models_1 = _a.sent();
                    server = new apollo_server_1.ApolloServer({ typeDefs: typedef_1.default, resolvers: resolvers_1.default,
